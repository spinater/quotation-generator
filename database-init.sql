...
-- This will create all tables, indexes, and foreign keys for the Thai Quotation & Receipt Generator
...
-- Seed: Insert sample company
INSERT INTO "companies" ("id", "name", "nameEn", "taxId", "address", "phone", "email", "bankName", "bankAccountNumber", "bankAccountName", "isDefault", "createdAt", "updatedAt")
VALUES (
