...
## 17. Agent-Generated Markdown File Management
...
✓ Examples:
  - .github/agent-md/2025-01-15-143022-api-analysis.md
  - .github/agent-md/2025-01-15-150533-reconciliation-spec.md
  - .github/agent-md/2025-01-16-091045-database-schema.md
```
...
```
.github/agent-md/
├── 2025-01-15-143022-api-analysis.md
├── 2025-01-15-150533-reconciliation-spec.md
├── 2025-01-16-091045-database-schema.md
...
- HHmmss: Time of creation (24-hour format)
- descriptive-name: Kebab-case description of content

Examples:
✓ 2025-01-18-143022-dioxus-migration-analysis.md
✓ 2025-01-18-150533-health-check-specification.md
✓ 2025-01-18-161045-performance-optimization-plan.md
```

### Cleanup Guidelines

```
✓ Archive docs older than 6 months to .github/agent-md/archive/
✓ Maintain README.md index with document purposes
✓ Keep relevant docs accessible in main agent-md directory
✓ Update index when archiving documents
```
...
- Research, analysis, specifications
- Generated during planning/investigation phase
- Timestamped for historical tracking
- Referenced from task files when relevant

Task Files (.github/tasks/):
- Actionable work items with checklists
- Track implementation progress
- Include verification steps and completion status
- May reference agent-generated docs for context

Relationship:
Agent MD (Research) → Task Files (Implementation) → Completion
```
